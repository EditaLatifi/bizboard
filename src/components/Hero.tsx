...
export default function BigHeroFinal() {
  ...
  return (
    <section className="relative min-h-screen w-full bg-[#F9FAFB] text-[#1E1E1E] flex items-center justify-center px-2 overflow-hidden">
      {/* Callout Bubble */}
      ...
      <div className="max-w-6xl w-full flex flex-col md:flex-row items-center justify-between gap-12 z-10">
        ...
        <div className="max-w-xl text-center md:text-left">
          ...
          {/* Main Heading */}
          <h1 className="text-5xl md:text-6xl font-extrabold font-clash leading-tight mb-6 tracking-tight">
          ...
          <p className="text-lg text-gray-700 mb-10">
            ...
            Start running your business smarter — <br></br>with one dashboard that does it all.
          </p>
        ...
        {/* Hero Image */}
       <div className="w-[480px] sm:w-[520px] md:w-[560px] lg:w-[600px] transform hover:scale-105 transition duration-500 ease-in-out">
  <Image
    src={heroImage}
